...
type UIClient struct {
	...
	BlockchainID           string `yaml:"arbitrum_chain_id" json:"BLOCKCHAIN_ID"`
	ContractDAD            string `yaml:"arbitrum_dad_token_address" json:"CONTRACT_DAD_ADDRESS"`
	ContractFaucet         string `yaml:"arbitrum_faucet_contract_address" json:"CONTRACT_FAUCET_ADDRESS"`
	ContractMOM            string `yaml:"arbitrum_mom_token_address" json:"CONTRACT_MOM_ADDRESS"`
	ContractNFT            string `yaml:"arbitrum_nft_contract_address" json:"CONTRACT_NFT_ADDRESS"`
	ContractStake          string `yaml:"arbitrum_stake_token_address" json:"CONTRACT_STAKING_ADDRESS"`
