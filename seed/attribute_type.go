...
func seedAttributeType(ctx context.Context, node universe.Node) error {
	...
	items := []*item{
		{
			pluginID:      mid.MustParse(OdysseyHackatonPluginID),
		...
		//
		{
			pluginID:      mid.MustParse(miroPluginID),
			attributeName: "state",
		...
		//
		{
			pluginID:      mid.MustParse(videoPluginID),
			attributeName: "state",
		...
		//
		{
			pluginID:      mid.MustParse(high5PluginID),
			attributeName: "count",
		...
		//
		{
			pluginID:      mid.MustParse(googleDrivePluginID),
			attributeName: "config",
		...
		//
		{
			pluginID:      mid.MustParse(textPluginID),
			attributeName: "state",
		...
		//
		{
			pluginID:      mid.MustParse(imagePluginID),
			attributeName: "state",
