...
func seedObjectTypes(node universe.Node) error {
	...
	items := []*item{
		{
			id:             mid.MustParse(NodeObjectTypeID),
			asset2dID:      nil,
			asset3dID:      nil,
			objectTypeName: "Node",
			categoryName:   "Nodes",
			...
			options: &entry.ObjectOptions{
				...
				AllowedSubObjects: []mid.ID{},
			},
		},
		{
			id:             mid.MustParse("88415343-90db-4d23-a9e7-79a11aaaaf04"),
			asset2dID:      nil,
			asset3dID:      nil,
			...
			options: &entry.ObjectOptions{
				...
				ChildPlacements: map[mid.ID]*entry.ObjectChildPlacement{
					mid.MustParse("00000000-0000-0000-0000-000000000000"): &entry.ObjectChildPlacement{
		...
		{
			id:             mid.MustParse("27456794-f9aa-44b5-90a5-e307fc21bc3d"),
			asset2dID:      nil,
			asset3dID:      utils.GetPTR(mid.MustParse(dockingStationAsset3dID)),
		...
		//
		{
			id:             mid.MustParse("a41ee21e-6c56-41b3-81a9-1c86578b6b3c"),
			asset2dID:      nil,
			asset3dID:      nil,
		...
		{
			id:             mid.MustParse("b59abd4d-f54d-4a97-8b6d-16a2037ddd8f"),
			asset2dID:      utils.GetPTR(mid.MustParse(dockingStationAsset2dID)),
			asset3dID:      utils.GetPTR(mid.MustParse("a6862b31-8f80-497d-b9d6-8234e6a71773")),
		...
		{
			id:             mid.MustParse("4ed3a5bb-53f8-4511-941b-07902982c31c"),
			asset2dID:      nil,
			asset3dID:      nil,
		...
		{
			id:             mid.MustParse("4fe4ed05-9024-461a-97d6-22666e8a4f46"),
			asset2dID:      nil,
			asset3dID:      utils.GetPTR(mid.MustParse("6846dba3-38b1-4540-a80d-4ba04af4111e")),
		...
		{
			id:             mid.MustParse("69d8ae40-df9b-4fc8-af95-32b736d2bbcd"),
			asset2dID:      nil,
			asset3dID:      nil,
		...
		{
			id:             mid.MustParse("d7a41cbd-5cfe-454b-b522-76f22fa55026"),
			asset2dID:      nil,
			asset3dID:      utils.GetPTR(mid.MustParse("313a597a-8b9a-47a7-9908-52bdc7a21a3e")),
		...
		{
			id:             mid.MustParse("75b56447-c4f1-4020-b8fc-d68704a11d65"),
			asset2dID:      nil,
			asset3dID:      nil,
		...
		{
			id:             mid.MustParse("f9607e55-63e8-4cb1-ae47-66395199975d"),
			asset2dID:      nil,
			asset3dID:      nil,
