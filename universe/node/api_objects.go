...
func (n *Node) apiObjectsCreateObject(c *gin.Context) {
	...
	objectTemplate := helper.ObjectTemplate{
	...
	objectID, err := helper.AddObjectFromTemplate(&objectTemplate, true)
	if err != nil {
...
func (n *Node) apiObjectsCreateObjectFromTemplate(c *gin.Context) {
	...
	objectID, err := helper.AddObjectFromTemplate(&template, true)
	if err != nil {
