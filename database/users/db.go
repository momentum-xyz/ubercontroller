...
func (db *DB) GetUserByID(ctx context.Context, userID mid.ID) (*entry.User, error) {
	var user entry.User
...
func (db *DB) GetUsersByIDs(ctx context.Context, userIDs []mid.ID) ([]*entry.User, error) {
...
func (db *DB) GetUserWalletByUserID(ctx context.Context, userID mid.ID) (*string, error) {
	var wallet string
...
func (db *DB) GetUserProfileByUserID(ctx context.Context, userID mid.ID) (*entry.UserProfile, error) {
...
func (db *DB) RemoveUsersByIDs(ctx context.Context, userIDs []mid.ID) error {
...
func (db *DB) RemoveUserByID(ctx context.Context, userID mid.ID) error {
...
func (db *DB) UpdateUserUserTypeID(ctx context.Context, userID mid.ID, userTypeID mid.ID) error {
...
func (db *DB) UpdateUserOptions(ctx context.Context, userID mid.ID, options *entry.UserOptions) error {
...
func (db *DB) UpdateUserProfile(ctx context.Context, userID mid.ID, profile *entry.UserProfile) error {
